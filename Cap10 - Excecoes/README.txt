...
d. digite -> java tratamentoExcecoes4.ExcecoesCaso4
e. digite -> java tratamentoExcecoes5.ExcecoesCaso5
...
1. Revisando um try-catch-finally simples
2. Revisando try aninhado com exemplo de multi-catch
